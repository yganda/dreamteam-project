        ...
        <div className="home-page__news-block">
          <div className="home-page__news-block--content">
            <div className="home-page__first-block--container">
              <div className="home-page__first-block--title">
                NOEL LEARN NEW SKILL<br/>
                ON FAMILY PROJECT
              </div>
              <div className="home-page__first-block--text">
                «I love beautiful movies. If a film is eye-candy with<br/>
                carefully designed decorations, masterful camerawork,<br/>
                lighting, and architectural frames, I can forgive<br/>
                anything»
              </div>
